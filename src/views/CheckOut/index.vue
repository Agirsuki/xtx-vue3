...
const getCheckoutInfo = async () => {
  ...
  defaultAddress.value = result.userAddresses.find(address => address.isDefault === 0)
}
...
<template>
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @click="visible = true">切换地址</el-button>
  ...
  <!-- 切换地址 -->
  <el-dialog v-model="visible" title="切换收货地址" width="30%" center>
  <div class="addressWrapper">
    <div class="text item" :class="{ active: activeAddress.id === item.id}" v-for="item in checkInfo.userAddresses"  :key="item.id" @click="activeAddress = item">
      <ul>
